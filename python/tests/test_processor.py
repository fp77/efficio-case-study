...
def test_join_attaches_hierarchy_fields():
    """
    Simple test to verify that join_company_data correctly attaches hierarchy fields from the family tree
    """
    ...
    family_tree = pd.DataFrame([
        {"duns": "111111111", "parent_company_id": None,        "hierarchy_level": 1, "global_ultimate_id": "111111111"},
        {"duns": "222222222", "parent_company_id": "111111111", "hierarchy_level": 2, "global_ultimate_id": "111111111"},
    ])
