...
> **Note for disclosure:** This project was developed with the assistance of Copilot. It was used to create the most of this README file, aid in the analysis of the input json files, assist in code debugging, and correcting pylint scoring. 
---
